...
export function exportMaterialsCSV(S: AstralState, filename = "astral-materials.csv"): void {
  ...
  const section = (title: string) => { out.push([]); out.push([title]); };

  section("STUDS BY WALL");
  out.push(["Wall", "Length (mm)", "Height (mm)", "Spacing", "Size", "Common", "Jack", "Trimmer", "Corner", "Nogs (lm)", "Plates (lm)"]);
  t.studs.forEach((l) => out.push([
    l.wallName, l.length_mm, l.height_mm, l.spacing_mm, l.size,
    l.common, l.jack, l.trimmer, l.corner, l.nogs_lm, l.plates_lm,
  ]));
  out.push(["TOTAL", "", "", "", t.studTotals.size,
    t.studTotals.studs_pcs, "", "", "",
    t.studTotals.nogs_lm, t.studTotals.plates_lm]);

  section("DOOR / WINDOW SCHEDULE");
  out.push(["Ref", "Kind", "Wall", "Width (mm)", "Height (mm)", "Head (mm)", "Sill (mm)", "Off (mm)", "Area (m²)"]);
  t.openings.forEach((o) => out.push([
    o.ref, o.kind, o.wallName, o.width_mm, o.height_mm, o.head_mm, o.sill_mm, o.off_mm, o.area_m2,
  ]));

  section("LINTEL SCHEDULE");
  out.push(["Ref", "Size", "Span (mm)", "Count", "Length each (mm)", "Total (lm)", "SED"]);
  t.lintels.forEach((r) => out.push([r.ref, r.size, r.span_mm, r.count, r.length_per_mm, r.total_lm, r.sed ? "yes" : ""]));

  section("BRACING SCHEDULE (indicative)");
  out.push(["Wall", "Length (mm)", "Available (mm)", "Panels", "BU", "SED"]);
  t.bracing.forEach((b) => out.push([b.wallName, b.length_mm, b.available_mm, b.panels, b.bu, b.sed ? "yes" : ""]));
  ...
  t.areas.forEach((a) => out.push([
    a.item, a.gross_m2, a.openings_m2, a.net_m2, a.waste_pct, a.order_m2, a.spec,
  ]));
...
export function exportMaterialsXLSX(S: AstralState, filename = "astral-materials.xlsx"): void {
  ...
  const studAOA: (string | number)[][] = [
    ["Wall", "Length (mm)", "Height (mm)", "Spacing", "Size", "Common", "Jack", "Trimmer", "Corner", "Nogs (lm)", "Plates (lm)"],
    ...t.studs.map((l) => [l.wallName, l.length_mm, l.height_mm, l.spacing_mm, l.size,
      l.common, l.jack, l.trimmer, l.corner, l.nogs_lm, l.plates_lm]),
    ["TOTAL", "", "", "", t.studTotals.size,
      t.studTotals.studs_pcs, "", "", "", t.studTotals.nogs_lm, t.studTotals.plates_lm],
  ];
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet(studAOA), "Studs");

  const openAOA: (string | number)[][] = [
    ["Ref", "Kind", "Wall", "Width (mm)", "Height (mm)", "Head (mm)", "Sill (mm)", "Off (mm)", "Area (m²)"],
    ...t.openings.map((o) => [o.ref, o.kind, o.wallName, o.width_mm, o.height_mm, o.head_mm, o.sill_mm, o.off_mm, o.area_m2]),
  ];
  ...
  const lintAOA: (string | number)[][] = [
    ...
    ...t.lintels.map((r) => [r.ref, r.size, r.span_mm, r.count, r.length_per_mm, r.total_lm, r.sed ? "yes" : ""]),
  ];
  ...
  const brAOA: (string | number)[][] = [
    ...
    ...t.bracing.map((b) => [b.wallName, b.length_mm, b.available_mm, b.panels, b.bu, b.sed ? "yes" : ""]),
  ...
  const arAOA: (string | number)[][] = [
    ...
    ...t.areas.map((a) => [a.item, a.gross_m2, a.openings_m2, a.net_m2, a.waste_pct, a.order_m2, a.spec]),
  ];
